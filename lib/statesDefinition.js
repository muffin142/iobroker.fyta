...
module.exports = {
	...
	"plant": {
						...
						wifi_status: {
							...
							def: -1,
							states: {
								"-1": "Never connected to any hub or user doesnt have any hub or plant doesnt have sensor",
						...
						temperature_status: {
							...
							role: "info.status",
							def: 0,
							states: { 0: "No Data", 1: "Too Low", 2: "Low", 3: "Perfect", 4: "High", 5: "Too High" },
						},
						light_status: {
							name: "light_status",
							type: "number",
